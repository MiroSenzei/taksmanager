...
<style>
        body {
            background: url('./alvaro-reyes-qWwpHwip31M-unsplash.jpg');
                        ...
                        while($row=mysqli_fetch_assoc($res))
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="link-info" href="<?php echo SITEURL; ?>update-task.php?task_id=<?php echo $task_id; ?>">Update </a>
                                    
                                    <a class="link-warning" href="<?php echo SITEURL; ?>delete-task.php?task_id=<?php echo $task_id; ?>">Delete</a>
